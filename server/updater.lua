if Config.checkForUpdates then
    ...
    local resourceName = "unr3al_methvan"

    CreateThread(function()
        if GetCurrentResourceName() ~= "unr3al_methvan" then
            resourceName = "unr3al_methvan (" .. GetCurrentResourceName() .. ")"
        end
    end)

    CreateThread(function()
        while true do
            PerformHttpRequest("https://api.github.com/repos/1OSaft/unr3al_methvan/releases/latest", CheckVersion, "GET")
            Wait(3600000)
        end
    end)
    ...
    GetRepoInformations = function()
        ...
        PerformHttpRequest("https://api.github.com/repos/1OSaft/unr3al_methvan/releases/latest", function(err, response, headers)
            if err == 200 then
                ...
                repoURL = "https://github.com/1OSaft/unr3al_methvan"
            end
        end, "GET")
